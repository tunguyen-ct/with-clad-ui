...
<Meta
  title="Overview/Solution Rationale"
  parameters={{ previewTabs: { canvas: { hidden: true } } }}
/>

# Solution Rationale

Clad UI uses a new hybrib approach of building React components: CSS-in-JS during component authoring, but final output is still static CSS.

## Why Clad UI uses Linaria?

From Linaria's Docs: [Benefits](https://github.com/callstack/linaria/blob/master/docs/BENEFITS.md).
